    ...
    def test_named_groups_form(self):
        ...
        if VERSION >= (4, 0):
                ...
                """<p><label>Province or State:</label>
                    <div class="multiselectfield" id="id_published_in">
                        <div>
                            ...
                            <div><label for="id_published_in_0_1"><input checked class="multiselectfield" id="id_published_in_0_1" name="published_in" type="checkbox" value="BC" />British Columbia</label></div>
                        </div>
                        <div>
                            <label>USA - States</label>
                            <div><label for="id_published_in_1_0"><input checked class="multiselectfield" id="id_published_in_1_0" name="published_in" type="checkbox" value="AK" />Alaska</label></div>
            ...
            expected_html = str(
                ...
                """<li><label for="id_published_in_0_1"><input checked class="multiselectfield" id="id_published_in_0_1" name="published_in" type="checkbox" value="BC" /> British Columbia</label></li></ul></li>\n"""
                """<li>USA - States<ul id="id_published_in_1"><li><label for="id_published_in_1_0"><input checked class="multiselectfield" id="id_published_in_1_0" name="published_in" type="checkbox" value="AK" /> Alaska</label></li>\n"""
